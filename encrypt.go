...
func testEncrypt() {
	...
	fmt.Println(err)
	err, pub := DumpPublicKeyBytes(&pri.PublicKey)
	fmt.Println(string(pub))

	publickey, err := LoadPublicKeyBytes(pub)

	b2, err := EncryptPkcs([]byte("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"+
		"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"), publickey)
	err, b4 := DumpPrivateKeyBytes(pri)
	b5, err := DecryptPkcsByBytes(b2, b4)
	b3, err := DecryptPkcs(b2, pri)
	b12, err := Encrypt([]byte("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"+
		"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"), publickey)
	b13, err := Decrypt(b12, pri)
	fmt.Println(string(b3), string(b5), string(b13))
}
